// 本文件由FirstUI授权予江安红云智慧科技有限公司（手机号：   199 600     907 60，身份证尾号：  4 9 782 4）专用，请尊重知识产权，勿私下传播，违者追究法律责任。
...
export default class WebGLRenderingContext {
    ...
    getBufferParameter = function (target, pname) {
        ...
        const [type, res] = getBufferParameter;// echo建议
        return res;
    }
    ...
    texParameterf = function (target, pname, param) {
        WebGLRenderingContext.GBridge.callNative(// echo建议
            this._canvas.id,
    ...
    uniformMatrix4fv = function (location, transpose, value) {
        WebGLRenderingContext.GBridge.callNative(// todo: 待修改
            this._canvas.id,
