      ...
      <view class="example">
        ...
        >
              ...
              >
                <uni-list>
                  <uni-list-item
                    ...
                    clickable
                    @click="baseFormData.name = c.value; $refs.popup.close()"
                    :key="i"
                    :title="c.value"
                    :rightText="c.label"
                  />
          ...
          <uni-forms-item label="选择技能">
            <uni-data-select
              v-model="baseFormData.skills"
              :localdata="skillsRange"
            >
            </uni-data-select>
          </uni-forms-item>
        </uni-forms>
        ...
        >
          ...
          >
            <view class="form-item">
              <uni-easyinput
                v-model="dynamicFormData.domains[index].value"
                placeholder="请输入域名"
              />
              <button
                class="button"
...
export default {
  ...
  computed: {
    ...
    filteredChoices() {
      return this.baseFormData.name ? this.namechoices.filter(e => e.value.includes(this.baseFormData.name)) : []
    },
  },
  async onLoad() {
    const { data } = await Http.get("https://zzb.jazzb.cn/system/dept/outlist", { foo: "bar" })
    this.namechoices = data.data.map(e => ({ value: e.deptName }))
  },
  onReady() {
  ...
  methods: {
    ...
    del(id) {
      const index = this.dynamicLists.findIndex(v => v.id === id)
